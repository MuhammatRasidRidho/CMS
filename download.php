...
if ($file_extension=='php'){
	echo "<h1>Access forbidden!</h1>
			...
			Silahkan hubungi <a href='mailto:redaksi@asfamedia.com'>webmaster</a>.</p>";
	exit;
}
else{
	mysql_query("UPDATE tdownload set hits=hits+1 WHERE namafile='$filename'");
